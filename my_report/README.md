...
Με την βοήθεια του παραδείγματος, να αλλάξετε το Example 9-8 (A snake following the mouse), ώστε αντί για το ποντίκι η είσοδος να γίνεται από ένα (μονόχρωμο) αντικείμενο της επιλογής σας (Exercise 16-5). Σε σχέση με το παραδοσιακό ποντίκι ποια είναι τα πλεονεκτήματα και ποια τα μειονεκτήματα αυτής της τεχνικής ελέγχου ενός ή περισσότερων σημείων σε μια οθόνη?
