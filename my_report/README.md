...
Στη συνέχεια, πρόσθεσα κάποιες εντολες if οι οποίες αντιστοιχούν σε όλες τις επιλογές και για την κάθε επιλογή γίνονται οι αλλαγές όπως πχ σε μετασχηματισμούς.

Παρακάτω παραθέτω φωτογραφίες από το πως λειτουργεί ο κώδικάς μου.

![Screenshot (1)](https://user-images.githubusercontent.com/101421118/212183946-12b7a338-d3c1-4349-b830-c2a639209c58.png)

![Screenshot (2)](https://user-images.githubusercontent.com/101421118/212183967-21387fee-4015-4569-b2a2-e7ad88db8834.png)

![Screenshot (3)](https://user-images.githubusercontent.com/101421118/212183981-8e9fbceb-f14a-4f83-a93e-da6add65ae24.png)
...
Αρχικά, διαλέγω τον προσομοιωτή για την διαδικασία του προγραμματισμού και σχεδιασμού για πιο εύκολο έλεγχο. Επίσης, παρατρώ ότι δεν υπάρχει φόβος για βλάβες και λάθη. Την κανονική κάμερα επιλέγω να τη χρησιμοποιήσω όταν βρίσκομαι στο τελικό στάδιο, δηλαδή το στάδιο της πρωτοτυποποίησης.
