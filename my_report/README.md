...
Μελέτησα, επεξεργάστηκα και παρατήρησα το παραπάνω παράδειγμα(TUIO demo), έτσι ώστε να μπορέσω να ξεκινήσω να φτιάχνω μια εφαρμογή επεξεργασίας εικόνας φωτογραφιών (π.χ. μεγέθυνση, μετακίνηση, αντίθεση, φωτεινότητα, κτλ) η οποία θα χρησιμοποιεί την κάμερα για την αναγνώριση και παρακολούθηση των κωδικών fiducials. (ΕΔΩ ΕΧΩ ΜΕΙΝΕΙ)
...
Οι κωδικοί fiducials θα αντιπροσωπεύουν είτε μια φωτογραφία, είτε ένα φίλτρο επεξεργασίας εικόνας. Το παραδοτέο θα πρέπει να περιέχει ενδεικτικές οθόνες όπου θα φαίνεται η αναγνώριση τουλάχιστον δύο κωδικών ταυτόχρονα σε δύο τουλάχιστον καταστάσεις της εφαρμογής. Για να το πετύχετε αυτό θα πρέπει να εκτυπώσετε τους κωδικούς, καθώς και να γίνει χρήση της μηχανής υπολογιστικής όρασης reacTIVision που εγκαταστήσατε στο προηγούμενο ερώτημα. Σε ποια φάση της σχεδίασης και ανάπτυξης του υλικό/λογισμικού της διάδρασης θα διαλέγατε την κανονική κάμερα ή τον προσομοιωτή?
